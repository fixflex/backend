...
const offer_service_1 = require("../../services/tasks/offer.service");
...
let OfferController = class OfferController {
    constructor(offerService) {
        ...
        this.createOffer = (0, express_async_handler_1.default)(async (req, res, next) => {
            ...
            res.status(201).json((0, customResponse_1.default)({ data: offer, success: true, status: 201, message: 'Offer created', error: false }));
        });
        this.getOffersByTaskId = (0, express_async_handler_1.default)(async (req, res) => {
            ...
            res.status(200).json((0, customResponse_1.default)({ data: offers, success: true, status: 200, message: null, error: false }));
        });
        this.getOfferById = (0, express_async_handler_1.default)(async (req, res, next) => {
            ...
            res.status(200).json((0, customResponse_1.default)({ data: offer, success: true, status: 200, message: null, error: false }));
        });
        this.updateOffer = (0, express_async_handler_1.default)(async (req, res, next) => {
            ...
            if (!offer)
                return next(new HttpException_1.default(404, `Offer with id ${req.params.id} not found`));
            res.status(200).json((0, customResponse_1.default)({ data: offer, success: true, status: 200, message: 'Offer updated', error: false }));
        });
        this.deleteOffer = (0, express_async_handler_1.default)(async (req, res, next) => {
            ...
            if (!offer)
                return next(new HttpException_1.default(404, `Offer with id ${req.params.id} not found`));
            res.status(200).json((0, customResponse_1.default)({ data: null, success: true, status: 204, message: 'Offer deleted', error: false }));
        });
    }
};

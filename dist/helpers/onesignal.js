...
exports.OneSignalApiHandler = void 0;
...
class OneSignalApiHandler {
    ...
    getHeaders() {
        return {
            ...
            Authorization: `Basic ${validateEnv_1.default.API_KEY}`,
    ...
    async createNotification(options) {
        const notification = {
            ...
            app_id: validateEnv_1.default.APP_ID,
        };
        try {
    ...
    async viewListOfNotifications() {
        const url = `${this.baseUrl}notifications?app_id=${validateEnv_1.default.APP_ID}`;
        try {
    ...
    async sendNotification(userId, options) {
        ...
        try {
            const data = await this.makeRequest(url, 'POST', { data: JSON.stringify(notification) });
            console.log(data);
        }
        catch (error) {
    ...
    async getNotificationDetails(notificationId) {
        const url = `${this.baseUrl}notifications/${notificationId}?app_id=${validateEnv_1.default.APP_ID}`;
        try {
            const data = await this.makeRequest(url, 'GET');
            console.log(data);
        }
    ...
    async updateNotification(notificationId, options) {
        ...
        try {
            const data = await this.makeRequest(url, 'PUT', { data: JSON.stringify(notification) });
            console.log(data);
        }
        catch (error) {
    ...
    async deleteNotification(notificationId) {
        const url = `${this.baseUrl}notifications/${notificationId}?app_id=${validateEnv_1.default.APP_ID}`;
        try {
            const data = await this.makeRequest(url, 'DELETE');
            console.log(data);
        }
        catch (error) {
...
exports.OneSignalApiHandler = OneSignalApiHandler;

